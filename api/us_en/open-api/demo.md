...
```cmd
curl -X POST \
  https://openapi.momoex.com/open/api/create_order \
...
Request request = new Request.Builder()
  .url("https://openapi.momoex.com/open/api/create_order")
  .post(body)
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://openapi.momoex.com/open/api/create_order",
